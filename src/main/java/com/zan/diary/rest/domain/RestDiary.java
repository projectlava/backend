...
public class RestDiary extends ResourceSupport implements Serializable {
	...
	public static RestDiary fromDiaryDetails(DiaryDetails diaryDetails) {

		RestDiary diary = new RestDiary();
